...
type (
	executionFunc       func(pc *uint64, env *EVM, contract *Contract, memory *Memory, stack *Stack, rstack *ReturnStack, precompiledContracgts ContractsInterface, msgHash *common.Hash) ([]byte, error)
...
type operation struct {
	execute       executionFunc       // op is the operation function
	gasCost       gasFunc             // gasCost is the gas function and returns the gas required for execution
	validateStack stackValidationFunc // validateStack validates the stack (size) for the operation
...
var (
	...
	fuxiInstructionSet  = newFuxiInstructionSet()
)

// newPanguInstructionSet returns the frontier, pangu instructions.
...
// NewFuxiInstructionSet returns the frontier, pangu and fuxi
// instructions that can be executed during the fuxi phase.
func newFuxiInstructionSet() [256]operation {
	// instructions that can be executed during the fuxi phase.
	...
	instructionSet[EXTCODEHASH] = operation{
		...
		gasCost:       constGasFunc(params.ExtcodeHashGas),
